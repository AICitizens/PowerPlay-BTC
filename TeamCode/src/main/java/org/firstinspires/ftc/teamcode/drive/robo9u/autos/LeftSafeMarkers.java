...
public class LeftSafeMarkers extends LinearOpMode {
    ...
    public void initialize()
    {
        ...
        fullTrajectory = drive.trajectorySequenceBuilder(new Pose2d())
                .UNSTABLE_addTemporalMarkerOffset(0, ()->mecanisme.lift.claw.Close())
                ...
                .UNSTABLE_addTemporalMarkerOffset(0, ()->{mecanisme.lift.nextStack(); mecanisme.lift.claw.Open();drive.setPoseEstimate(drive.getPoseEstimate().minus(averageErrorPose));})
                ...
                .UNSTABLE_addTemporalMarkerOffset(0.1, ()->mecanisme.lift.setLiftState(Lift.LiftState.Mid))
                .lineToSplineHeading(junctionPose)
                .UNSTABLE_addTemporalMarkerOffset(0, ()->{mecanisme.lift.setLiftState(Lift.LiftState.Ground); mecanisme.lift.claw.Open();})
